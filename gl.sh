...
curl -L -O https://www.kernel.org/pub/linux/kernel/v3.x/linux-${kernver}.tar.gz
...
for patch in 3078491 3078481 3074391 3074441 3074421 3074401 3074431 3074411; do
  curl -L https://patchwork.kernel.org/patch/$patch/raw/  \
    | sed 's/drivers\/platform\/x86\/chromeos_laptop.c/drivers\/platform\/chrome\/chromeos_laptop.c/' \
    | patch -p1
done
